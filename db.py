...
class Database:
    ...
    def _print_startup_message(self):
        ...
        print(f"\n{Fore.CYAN}{'='*50}")
        print(f"{Fore.CYAN}🚀 KESAV_UPLOADER Bot - Database Initialization")
    ...
    def _migrate_existing_users(self):
        ...
        try:
            update_result = self.users.update_many(
                ...
                {"$set": {"bot_username": "KESAV_UPLOADER"}}
            )
    ...
    def get_user(self, user_id: int, bot_username: str = "KESAV_UPLOADER") -> Optional[dict]:
        """
        Retrieve a user document
        
        Args:
            user_id: Telegram user ID
            bot_username: Bot username (default: "KESAV_UPLOADER")
    ...
    def is_user_authorized(self, user_id: int, bot_username: str = "KESAV_UPLOADER") -> bool:
        """
    ...
    def add_user(self, user_id: int, name: str, days: int, 
                bot_username: str = "KESAV_UPLOADER") -> tuple[bool, Optional[datetime]]:
        """
    ...
    def remove_user(self, user_id: int, bot_username: str = "KESAV_UPLOADER") -> bool:
        """
    ...
    def list_users(self, bot_username: str = "KESAV_UPLOADER") -> List[dict]:
        """
    ...
    def list_bot_usernames(self) -> List[str]:
        ...
        try:
            ...
            return usernames if usernames else ["KESAV_UPLOADER"]
        except Exception as e:
            print(f"{Fore.RED}List bot usernames error: {str(e)}{Style.RESET_ALL}")
            return ["KESAV_UPLOADER"]
    ...
    def get_user_expiry_info(self, user_id: int, bot_username: str = "KESAV_UPLOADER") -> Optional[dict]:
        """
...
# 🔰 Startup Message
print(f"\n{Fore.CYAN}{'='*50}")
print(f"🤖 Initializing KESAV_UPLOADER Bot Database")
print(f"{'='*50}{Style.RESET_ALL}\n")
